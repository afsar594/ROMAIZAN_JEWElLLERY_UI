...
@Component({
  selector: 'app-passportinoutdetail',
  templateUrl: './passportinoutdetail.component.html',
  styleUrls: ['./passportinoutdetail.component.scss']
})
export class PassportinoutdetailComponent implements OnInit {
  title: any;
  subtitle: any;
  ...
  GenerateReport() {
    ...
    this.reportService.GetPassportReport(paramBody)
